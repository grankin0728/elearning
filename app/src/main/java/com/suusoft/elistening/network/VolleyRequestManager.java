...
public class VolleyRequestManager {
	...
	public void getJSONObject(Uri.Builder builder, final RequestQueue volleyQueue, final IResponse listener) {
		...
		try {
			...
			jsonObjRequest.setRetryPolicy(new DefaultRetryPolicy(Paramfb.REQUEST_TIME_OUT, DefaultRetryPolicy.DEFAULT_MAX_RETRIES, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
