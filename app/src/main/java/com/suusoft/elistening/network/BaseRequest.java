...
import com.suusoft.elistening.network.multipart.MultiPartRequest;
                        ...
                        if (listener instanceof CompleteListener) {
                            ...
                            if (!apiResponse.isError()) {
                                ...
                                if (isCaching) {
                                    ...
                                    BaseDataStore.saveCaching(finalUrl, objectRoot, apiResponse.getValueFromRoot(Constant.Caching.KEY_TIME_UPDATED));
                                }
