...
public class AppUtil {
    ...
    public static void setImage(ImageView imageView, String imageUrl , Callback callback) {
        RequestOptions options = new RequestOptions()
                .centerCrop()
                .placeholder(R.drawable.placeholder)
                .error(R.mipmap.ic_launcher)
    ...
    public static void setImageBook(ImageView imageView, String imageUrl) {
        setImageWithSize(imageView, imageUrl, 300, 550);
    }
...
//        int screenWidth = view.getWidth();
    ...
    public static void setSelected(TextView textView, boolean check) {
        textView.setSelected(check);
    }

    // Set change theme
    @BindingAdapter("background_main")
    public static void setBackgroundMain(ViewGroup viewGroup, String color) {
        viewGroup.setBackgroundColor(Color.parseColor(color));
    }

    @BindingAdapter("background_radius")
    public static void setBackgroundRadius(ViewGroup viewGroup, String color) {
    ...
    @BindingAdapter("background_radius")
    public static void setBackgroundRadius(View view, String color) {
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setCornerRadius(6);
        gradientDrawable.setColor(Color.parseColor(color));
    ...
    public static void setColorText(TextView textView, String color) {
        textView.setTextColor(Color.parseColor(color));
    }

    @BindingAdapter("background_random")
    public static void setBackgroundRandom(ViewGroup viewGroup, int[] androidColors) {
        int randomAndroidColor = androidColors[new Random().nextInt(androidColors.length)];
        viewGroup.setBackgroundColor(randomAndroidColor);
    }
